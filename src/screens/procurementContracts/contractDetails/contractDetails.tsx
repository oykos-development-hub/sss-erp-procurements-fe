  ...
  const handleSave = async () => {
    try {
      const insertContractData = {
        ...
        date_of_signing: watch('date_of_signing').toString() || parseDate(contract?.date_of_signing, true).toString(),
        date_of_expiry: watch('date_of_expiry').toString() || parseDate(contract?.date_of_expiry, true).toString(),
